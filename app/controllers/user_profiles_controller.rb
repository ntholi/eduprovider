class UserProfilesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_profile.save
        reditect_path = current_student ? student_root_path : tutor_root_path
        format.html { redirect_to reditect_path, notice: 'Thank you for singing up' }
  ...
  private
    ...
    def user_profile_params
      params.require(:user_profile).permit(:email, :first_name, :last_name, :date_of_birth, :area_name, :city, :country, :phone_number)
    end
end
